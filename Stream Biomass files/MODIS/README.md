...
## 1. Request Parameters  
    ...
    Name: Stream Light MODIS_06252024  

    Date Completed:** 2024-06-30T13:11:24.955047  

    ID: fa3967fb-050a-40b3-9066-7c1a106da787  
    ...
    Details:  
        ...
        Coordinates:  
            ...
            ID, 29.935, -82.8  
            IU, 29.952669, -82.78602  
            GB, 29.832496, -82.681871  
            AM, 30.155033, -83.238212  
            OS, 29.640359, -82.954987  
            LF, 29.586135, -82.938279  
    
    Version: This request was processed by AppEEARS version 3.57  

## 2. Request File Listing  

- Comma-separated values file with data extracted for a specific product
  - Stream-Light-MODIS-06252024-MCD15A3H-061-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - Stream-Light-MODIS-06252024-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - Stream-Light-MODIS-06252024-request.json
- xml file
  - Stream-Light-MODIS-06252024-MCD15A3H-061-metadata.xml  
...
- Myneni, R., Knyazikhin, Y., Park, T. (2021). MODIS/Terra+Aqua Leaf Area Index/FPAR 4-Day L4 Global 500m SIN Grid V061. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2024-06-30 from https://doi.org/10.5067/MODIS/MCD15A3H.061. Accessed June 30, 2024.

## 9. Software Citation  

AppEEARS Team. (2024). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.57. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed June 30, 2024. https://appeears.earthdatacloud.nasa.gov
